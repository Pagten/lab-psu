...
#define timer2_oca_SET_INTERRUPT_ENABLED ( TIMSK2 |= _BV(OCIE2A) )                  // Enable OCR2A compare match interrupt
#define timer2_SET_MODE_0 ( TCCR2B &= ~_BV(WGM22); TCCR2A &= ~(_BV(WGM21) | _BV(WGM20)) ) // Set normal operation mode
